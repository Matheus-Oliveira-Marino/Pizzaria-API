...
// Classe que define uma janela de interface gráfica para vendas.
public class VendasTela extends JFrame implements MouseListener, MouseMotionListener,ActionListener
{

    // Garantir a consistência serial durante a desserialização.s
    ...
    protected JLabel
            ...
            lb_Produto = new JLabel("Digite o id do Produto cadastrado: "),
    ...
    public VendasTela()
    {
        super("Pizzaria do I AM CRUD"); // Configurações da janela principal.
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (e.getSource() == btn_adiconarItem)
        {
            ...
            // Caso não esteja, fornece uma mensagem solicitando o preenchimento correto.
            if (txtQtd.isEmpty() || txtIdProduto.isEmpty() &&((e.getSource() == btn_adiconarItem)))
            {
         ...
         if (e.getSource() == btn_alterarItem)
        {
            try
            {
                // Cria uma nova instância da tela de alteração de venda.
        ...
        if (e.getSource() == btn_excluirItem)
        {
            try
            {
                // Cria uma nova instância da tela de exclusão de venda.
        ...
        {
            // Cria uma nova instância da tela de visualização de vendas.
